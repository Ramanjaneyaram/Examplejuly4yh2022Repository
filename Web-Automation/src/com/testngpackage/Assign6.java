...
public class Assign6 {
	...
	private static void launchbrowser()
	{
	 ...
	 @Test(priority=2)
		...
		@Test(priority=7,dataProvider="DoModifyproject")
	private static void Modifyproject(String comment)
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\"taskListBlock\"]/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys(comment);
			Thread.sleep(2000);
    ...
    @DataProvider
    public Object[] DoModifyproject()
    {
    	Object obj[]= {"Smart work need"};
		return obj;
